...
- (void)viewDidLoad {
    ...
    _showTakePhotoBtn = (([_model.name isEqualToString:@"相册"] || [_model.name isEqualToString:@"Camera Roll"] ||  [_model.name isEqualToString:@"所有照片"] || [_model.name isEqualToString:@"All Photos"]) && tzImagePickerVc.allowTakePicture);
